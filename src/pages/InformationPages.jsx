...
export function Privacy() {
  return <InformationPage notice={false} eyebrow="Privacy notice" title="Privacy, in plain language." intro={IS_DEMO_MODE ? 'This portfolio is in Demo Mode. Contact, creator, newsletter, and Community journeys can be explored without real accounts or online publication.' : 'This deployment is in Live Mode. FashionXpress uses Supabase Auth for Community accounts and protected server workflows for contact, creator applications, and newsletters.'} sections={IS_DEMO_MODE ? [
    ...
    { title: 'Other local experiences', copy: ['Cart identifiers and quantities persist in this browser. Checkout, fictional Demo Wallet, mint progress, and Demo Vault records use session-only storage. They contain product IDs, concept choices, dates, and demo references, but no personal information, payment credentials, or real wallet details.', 'Camera preview and capture stay on your device; a frame is saved only if you choose to download it. Mint metadata is never uploaded or published. No wallet permission, signature, gas charge, smart-contract execution, blockchain transaction, token, ownership, or licence transfer occurs.'] },
    ...
    { title: 'What stays on your device', copy: ['Cart product choices and quantities are stored locally. Checkout, fictional Demo Wallet, mint simulation, and Demo Vault records remain in session storage; they carry no personal, payment, or real wallet details and have no monetary or blockchain value. Camera frames remain on your device unless you choose to download one. The site does not currently operate analytics.'] },
