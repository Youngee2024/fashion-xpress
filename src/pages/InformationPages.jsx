...
export function Privacy() {
  return <InformationPage notice={false} eyebrow="Privacy notice" title="Privacy, in plain language." intro={IS_DEMO_MODE ? 'This portfolio is in Demo Mode. Contact, creator, newsletter, and Community journeys can be explored without real accounts or online publication.' : 'This deployment is in Live Mode. FashionXpress uses Supabase Auth for Community accounts and protected server workflows for contact, creator applications, and newsletters.'} sections={IS_DEMO_MODE ? [
    ...
    { title: 'What stays on your device', copy: ['Cart product choices and quantities are stored locally. Checkout, fictional Demo Wallet, mint simulation, and Demo Vault records remain in session storage; they carry no personal, payment, or real wallet details and have no monetary or blockchain value. Virtual Try-On camera streams, photos, overlays, and captures stay in temporary device memory and are not uploaded, measured, or persisted; a file exists only if you download it. The site does not currently operate analytics.'] },
...
export function Terms() {
  return <InformationPage eyebrow="Prototype terms" title="Terms for exploring the concept." intro="This site demonstrates a possible digital-fashion experience. It does not offer a live marketplace or create a commercial relationship." sections={[
    ...
    { title: 'No transactions', copy: ['Checkout and minting experiences are local simulations. The Demo Wallet is fictional. No payment, real order, gas charge, signature, smart-contract execution, blockchain transaction, licence, ownership record, token, upload, publication, or delivery is created. Demo Vault records have no scarcity, monetary, or blockchain value.'] },
...
export function Licensing() {
  return <InformationPage eyebrow="Concept guide" title="Digital fashion licensing." intro="The current garments are demonstration pieces. No license or ownership right is transferred through this prototype." sections={[
    ...
    { title: 'Checkout concept terms', copy: ['Personal digital use, social/content use, and extended creator use in checkout are illustrative choices that change only a displayed demo total. They are not legally active licences, and selecting one transfers no rights.'] },
    { title: 'Mint simulation terms', copy: ['Mint Studio licence choices and metadata are local presentation concepts. Nothing is uploaded or made immutable, no asset is created on-chain, and no ownership, scarcity, resale, or licence right arises from a Demo Vault record.'] },
  ]}/>
}
...
export function RefundPolicy() {
  return <InformationPage eyebrow="Purchase status" title="Purchases are unavailable." intro="There is currently nothing to refund because FashionXpress does not accept payments, connect wallets, or deliver digital products." sections={[
    { title: 'Prototype checkout and minting', copy: ['Cart, checkout, Demo Vault, fictional wallet, and mint screens demonstrate interface states only. No payment, order, gas charge, signature, smart-contract execution, upload, token, blockchain transaction, ownership, or licence transfer occurs. Live payment and blockchain functionality are not enabled.'] },
...
export function AccessibilityStatement() {
  return <InformationPage eyebrow="Accessibility" title="Designed for more ways of navigating." intro="FashionXpress aims to make this portfolio prototype understandable and operable across keyboard, pointer, and assistive-technology use." sections={[
    { title: 'Current support', copy: ['The interface includes semantic headings, a skip link, visible keyboard focus, labelled controls, reduced-motion support, responsive layouts, and announced status feedback. Virtual Try-On provides labelled sliders, buttons, pointer dragging, and arrow-key garment positioning as alternatives to touch gestures. Community forms report validation and submission states; one-time-code verification is keyboard operable.'] },
