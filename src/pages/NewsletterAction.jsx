...
function NewsletterAction({ mode }) {
  ...
  async function submit() {
    if (IS_DEMO_MODE || submitting.current || availability !== 'available' || !token) return
