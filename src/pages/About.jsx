...
export function About() {
  return <>
    ...
    <section className="page-shell about-cta panel"><h2>Your vision belongs here.</h2><p>Join an atelier for people designing what fashion becomes next.</p><Link className="button" to="/get-started">Apply to create <Icon name="arrow" size={16}/></Link></section>
  </>
}
