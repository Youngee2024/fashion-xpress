...
export function About() {
  return <>
    ...
    <section id="values" className="page-shell values"><article><b>01</b><h3>Creator first</h3><p>Designers keep their voice, ownership, and a meaningful share of every sale.</p></article><article><b>02</b><h3>Progress, considered</h3><p>We use low-impact infrastructure and digital sampling to reduce physical waste.</p></article><article><b>03</b><h3>Access is power</h3><p>Great work deserves global reach, regardless of geography or gatekeepers.</p></article></section>
    <section className="page-shell about-cta"><div className="about-cta-visual"><SafeImage src="/images/3.jpg" alt="FashionXpress digital fashion creator"/><span>Atelier intake · 2026</span></div><div className="about-cta-copy"><span className="eyebrow">The next chapter</span><h2>Your vision<br/><em>belongs here.</em></h2><p>Join a global atelier for independent designers creating what fashion becomes next. Bring the point of view—we’ll help build the world around it.</p><div className="about-cta-actions"><Link className="button" to="/get-started">View creator atelier <Icon name="arrow" size={16}/></Link><Link className="text-link" to="/contact">Talk to our team <Icon name="arrow" size={16}/></Link></div><div className="about-cta-meta"><span><b>In preparation</b>Next creator intake</span><span><b>Direct contact</b>Creator enquiries by email</span></div></div></section>
  </>
}
